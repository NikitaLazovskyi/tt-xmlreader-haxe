...
HX_DEFINE_STACK_FRAME(_hx_pos_7c1bb80345434d73_14_new,"com.theproductengine.model.tabgroup.impl.BlueMediumTabGroup","new",0xb5132bfb,"com.theproductengine.model.tabgroup.impl.BlueMediumTabGroup.new","com/theproductengine/model/tabgroup/impl/BlueMediumTabGroup.hx",14,0x4e1e7b34)
HX_DEFINE_STACK_FRAME(_hx_pos_7c1bb80345434d73_72_new,"com.theproductengine.model.tabgroup.impl.BlueMediumTabGroup","new",0xb5132bfb,"com.theproductengine.model.tabgroup.impl.BlueMediumTabGroup.new","com/theproductengine/model/tabgroup/impl/BlueMediumTabGroup.hx",72,0x4e1e7b34)
HX_LOCAL_STACK_FRAME(_hx_pos_7c1bb80345434d73_105_changeTextOfMainTab,"com.theproductengine.model.tabgroup.impl.BlueMediumTabGroup","changeTextOfMainTab",0x0244dae3,"com.theproductengine.model.tabgroup.impl.BlueMediumTabGroup.changeTextOfMainTab","com/theproductengine/model/tabgroup/impl/BlueMediumTabGroup.hx",105,0x4e1e7b34)
HX_LOCAL_STACK_FRAME(_hx_pos_7c1bb80345434d73_111_changeColorForTabLater,"com.theproductengine.model.tabgroup.impl.BlueMediumTabGroup","changeColorForTabLater",0xaa5e1652,"com.theproductengine.model.tabgroup.impl.BlueMediumTabGroup.changeColorForTabLater","com/theproductengine/model/tabgroup/impl/BlueMediumTabGroup.hx",111,0x4e1e7b34)
namespace com{
...
void BlueMediumTabGroup_obj::__construct(Float x,Float y,Float clearence, ::com::theproductengine::ui::Tab tab,::Array< ::Dynamic> tabModelsData,Float maxWidth){
            	HX_GC_STACKFRAME(&_hx_pos_7c1bb80345434d73_14_new)
HXLINE(  25)		this->lineColor = 986933;
HXLINE(  24)		this->secondaryColor = 15329769;
HXLINE(  17)		this->scrollButton = 20;
HXLINE(  28)		 ::com::theproductengine::model::tabgroup::impl::BlueMediumTabGroup _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(  29)		this->mainSprite =  ::openfl::display::Sprite_obj::__alloc( HX_CTX );
HXLINE(  30)		this->tabModelsData = tabModelsData;
HXLINE(  32)		this->backgroundTabColor = 11652587;
...
HXLINE(  37)		txtFrmt->leftMargin = 40;
HXLINE(  38)		txtFrmt->rightMargin = 40;
...
HXLINE(  65)		while(true){
            			HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0, ::com::theproductengine::model::tabgroup::impl::BlueMediumTabGroup,_gthis, ::com::theproductengine::model::TabModel,data) HXARGC(1)
            			void _hx_run( ::openfl::events::MouseEvent event){
            				HX_GC_STACKFRAME(&_hx_pos_7c1bb80345434d73_72_new)
HXLINE(  73)				 ::com::theproductengine::model::tabgroup::impl::BlueMediumTabGroup _gthis1 = _gthis;
...
Dynamic BlueMediumTabGroup_obj::__CreateEmpty() { return new BlueMediumTabGroup_obj; }

void *BlueMediumTabGroup_obj::_hx_vtable = 0;

Dynamic BlueMediumTabGroup_obj::__Create(::hx::DynamicArray inArgs)
{
	::hx::ObjectPtr< BlueMediumTabGroup_obj > _hx_result = new BlueMediumTabGroup_obj();
	_hx_result->__construct(inArgs[0],inArgs[1],inArgs[2],inArgs[3],inArgs[4],inArgs[5]);
	return _hx_result;
}

bool BlueMediumTabGroup_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0e254c6b) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x0e254c6b;
	} else {
		return inClassId==(int)0x21af29fe;
	}
}

void BlueMediumTabGroup_obj::changeTextOfMainTab(::String text, ::openfl::text::TextField field){
            	HX_STACKFRAME(&_hx_pos_7c1bb80345434d73_105_changeTextOfMainTab)
...
HX_DEFINE_DYNAMIC_FUNC2(BlueMediumTabGroup_obj,changeTextOfMainTab,(void))

void BlueMediumTabGroup_obj::changeColorForTabLater( ::openfl::text::TextField tab){
            	HX_STACKFRAME(&_hx_pos_7c1bb80345434d73_111_changeColorForTabLater)
...
HX_DEFINE_DYNAMIC_FUNC1(BlueMediumTabGroup_obj,changeColorForTabLater,(void))


::hx::ObjectPtr< BlueMediumTabGroup_obj > BlueMediumTabGroup_obj::__new(Float x,Float y,Float clearence, ::com::theproductengine::ui::Tab tab,::Array< ::Dynamic> tabModelsData,Float maxWidth) {
	::hx::ObjectPtr< BlueMediumTabGroup_obj > __this = new BlueMediumTabGroup_obj();
	__this->__construct(x,y,clearence,tab,tabModelsData,maxWidth);
	return __this;
}

::hx::ObjectPtr< BlueMediumTabGroup_obj > BlueMediumTabGroup_obj::__alloc(::hx::Ctx *_hx_ctx,Float x,Float y,Float clearence, ::com::theproductengine::ui::Tab tab,::Array< ::Dynamic> tabModelsData,Float maxWidth) {
	BlueMediumTabGroup_obj *__this = (BlueMediumTabGroup_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(BlueMediumTabGroup_obj), true, "com.theproductengine.model.tabgroup.impl.BlueMediumTabGroup"));
	*(void **)__this = BlueMediumTabGroup_obj::_hx_vtable;
	__this->__construct(x,y,clearence,tab,tabModelsData,maxWidth);
	return __this;
}

BlueMediumTabGroup_obj::BlueMediumTabGroup_obj()
{
}

void BlueMediumTabGroup_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(BlueMediumTabGroup);
...
void BlueMediumTabGroup_obj::__Visit(HX_VISIT_PARAMS)
{
...
::hx::Val BlueMediumTabGroup_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
...
::hx::Val BlueMediumTabGroup_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 9:
...
void BlueMediumTabGroup_obj::__GetFields(Array< ::String> &outFields)
{
...
static ::hx::StorageInfo BlueMediumTabGroup_obj_sMemberStorageInfo[] = {
	{::hx::fsInt,(int)offsetof(BlueMediumTabGroup_obj,scrollButton),HX_("scrollButton",df,b5,a2,31)},
	{::hx::fsObject /*  ::openfl::display::Sprite */ ,(int)offsetof(BlueMediumTabGroup_obj,rectInnerBoxV),HX_("rectInnerBoxV",dd,3a,6b,c2)},
	{::hx::fsObject /*  ::openfl::display::Sprite */ ,(int)offsetof(BlueMediumTabGroup_obj,rectOuterV),HX_("rectOuterV",bf,e7,b0,11)},
	{::hx::fsObject /*  ::openfl::display::Sprite */ ,(int)offsetof(BlueMediumTabGroup_obj,rectInnerBoxH),HX_("rectInnerBoxH",cf,3a,6b,c2)},
	{::hx::fsObject /*  ::openfl::display::Sprite */ ,(int)offsetof(BlueMediumTabGroup_obj,rectOuterH),HX_("rectOuterH",b1,e7,b0,11)},
	{::hx::fsObject /* ::Array< ::Dynamic> */ ,(int)offsetof(BlueMediumTabGroup_obj,tabModelsData),HX_("tabModelsData",a9,aa,81,79)},
	{::hx::fsObject /*  ::openfl::text::TextField */ ,(int)offsetof(BlueMediumTabGroup_obj,previousTab),HX_("previousTab",5e,92,07,b3)},
	{::hx::fsInt,(int)offsetof(BlueMediumTabGroup_obj,secondaryColor),HX_("secondaryColor",4f,0d,f7,bb)},
	{::hx::fsInt,(int)offsetof(BlueMediumTabGroup_obj,lineColor),HX_("lineColor",cf,74,57,91)},
	{ ::hx::fsUnknown, 0, null()}
};
static ::hx::StaticInfo *BlueMediumTabGroup_obj_sStaticStorageInfo = 0;
#endif

static ::String BlueMediumTabGroup_obj_sMemberFields[] = {
...
::hx::Class BlueMediumTabGroup_obj::__mClass;

void BlueMediumTabGroup_obj::__register()
{
	BlueMediumTabGroup_obj _hx_dummy;
	BlueMediumTabGroup_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("com.theproductengine.model.tabgroup.impl.BlueMediumTabGroup",89,12,81,29);
	...
	__mClass->mMembers = ::hx::Class_obj::dupFunctions(BlueMediumTabGroup_obj_sMemberFields);
	__mClass->mCanCast = ::hx::TCanCast< BlueMediumTabGroup_obj >;
#ifdef HXCPP_SCRIPTABLE
	__mClass->mMemberStorageInfo = BlueMediumTabGroup_obj_sMemberStorageInfo;
#endif
#ifdef HXCPP_SCRIPTABLE
	__mClass->mStaticStorageInfo = BlueMediumTabGroup_obj_sStaticStorageInfo;
#endif
