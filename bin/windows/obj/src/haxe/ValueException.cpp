...
HX_LOCAL_STACK_FRAME(_hx_pos_dd2a1df6522401a7_36_unwrap,"haxe.ValueException","unwrap",0xe3875a0b,"haxe.ValueException.unwrap","D:\\HaxeToolkit\\haxe\\std/haxe/ValueException.hx",36,0x0835854f)
namespace haxe{
...
bool ValueException_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic ValueException_obj::unwrap(){
            	HX_STACKFRAME(&_hx_pos_dd2a1df6522401a7_36_unwrap)
